...
public class ShowCalendar extends VerticalLayout {
    ...
    public ShowCalendar(EntryDyzurDbRepo entryDyzurDbRepo, HospitalRepo hospitalRepo,
        ...
        CalendarDataProvider calendarDataProvider = new CalendarDataProvider();
...
//pobieranie
        ...
        Button btnSort = new Button("Sortuj dyżury",event ->{
       ...
       // akcja po kliknięciu na istniejące wydarzenie
        ...
        calendarDataProvider.addEntriesFromDBWithHospitalNameAndDept(calendar,entryDyzurDbRepo,
                LocalDate.now(),userRepository, chosenView,currentlyChosenTimeSpan,hospitalId,hospitalIdDept);
    }
